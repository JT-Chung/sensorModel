<template>
  <el-card shadow="hover" :body-style="echo.getCardBodyStyle">
    <div v-spacing-bottom style="display: flex; justify-content: space-between"><b>Connection：</b> <span @click="triggerFullScreen"><el-icon style="color: #efefef"><Switch /></el-icon></span></div>
    <el-space size="large">
      <span>
        Front
