...
import { rafTimeout, cancelRaf } from './slider.lib.js'
interface Props {
...
<template>
  <div :class="['m-slider', { disabled: disabled }]" ref="slider" :style="`width: ${totalWidth};`">
    ...
    <div
        ...
        @touchstart="disabled ? () => false : onLeftMouseDown()"
        @touchmove="disabled ? () => false : onLeftMouseDown()"
        @touchend="disabled ? () => false : onLeftMouseDown()"
    >
    ...
    <div
        ...
        @touchstart="disabled ? () => false : onRightMouseDown()"
        @touchmove="disabled ? () => false : onRightMouseDown()"
        @touchend="disabled ? () => false : onRightMouseDown()"
    >
      <div v-if="!hideTip" class="u-handle-tooltip">
        {{ rightValue }}
        <div class="m-arrow">
